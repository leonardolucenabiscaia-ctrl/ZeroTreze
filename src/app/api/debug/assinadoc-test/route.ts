...
export async function GET() {
  ...
  try {
    ...
    const resultado = await enviarDocumentoParaAssinatura({
      nomeArquivo: "Diagnóstico Zero Treze",
      pdfBuffer,
      emailSignatario: "leonardolucenabiscaia@gmail.com",
      mensagem: "Teste de diagnóstico da integração AssinaDoc.",
    });
    ...
    passos.stack = error instanceof Error ? (error.stack ?? "") : "";
